...
# Modified the environment for the agent to play
# Removed sound and switched the Menu_Renderer in create() to Game_Renderer to launch the game
# Calls begin_game() to automatically start the agent
...
class Main:
    ...
    def create(self):
        renderer = Game_Renderer(self.window)
        self.window.setCentralWidget(renderer.render())
        renderer.begin_game()
